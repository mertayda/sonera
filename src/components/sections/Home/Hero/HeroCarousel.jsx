...
const HeroCarousel = () => {
  ...
  return (
    <section id="whoweare" className="carousel slide">
                  ...
                  <div className="col">
                    <div className="d-flex flex-column  justify-content-start">
                      ...
                      <p className="text-white">
                        Our cleaning experts deliver the highest quality of
                        clean you can always count, let us help you with
                        cleaning and disinfecting now.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-12 col-lg-4 d-flex ">
                <div className="row w-100 h-100">
                  <div className="col-12 d-flex  justify-content-center justify-content-lg-end">
                    <a
                      className="video-btn"
                      href="https://www.youtube.com/watch?v=kWsSGa_Mbog"
                    >
